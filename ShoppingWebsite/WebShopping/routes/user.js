...
router.post('/signup',(req,res) => {
  userHelpers.doSignup(req.body).then((response) => {
    ...
    req.session.loggedIn = true //req.session.user.loggedIn = true
    res.redirect('/')
...
router.post('/login',(req,res) => {
  userHelpers.doLogin(req.body).then((response) => {
    if(response.status){
      //After login redirect to home page and back button will not load login page again
...
router.get('/logout',(req,res) => {
  req.session.destroy() //  req.session.user=null
  res.redirect('/')
})
